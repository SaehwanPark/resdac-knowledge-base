...
provenance manifests, and retained generated metadata, graph, parsed text,
chunk, and variable artifacts from that snapshot.
...
- [ARCHITECTURE.md](ARCHITECTURE.md): repository surfaces, data flow, constraints, and current implementation state.
- [ROADMAP.md](ROADMAP.md): strategic layering and future direction.
- [team-spec.md](docs/harness/cms-kb/team-spec.md): agent handoff contract for archive, extraction, parsing, and QA workflows.
- [LESSONS.md](LESSONS.md): recurring setup traps, debugging lessons, and workflow gotchas.
